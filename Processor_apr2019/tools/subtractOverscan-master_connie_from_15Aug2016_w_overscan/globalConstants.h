...
//(Guillermo) Interesting region of input file to process for the output
//const double kPrescan = 6;
//Rows to process
const int yProc[2] = {1,1055};
//Prescan region of both amplifiers (ej: {min. Col , max. Col})
const int xPreB[2] = {1,8};
const int xPreA[2] = {8533,8540};
//Active region of both amplifiers (ej: {min. Col , max. Col})
const int xActB[2] = {9,4270};//{9,4120};
const int xActA[2] = {4271,8532};//{4421,8532};
//Overscan region of both amplifiers (ej: {min. Col , max. Col})
const int xOverB[2] = {4121,4270};
const int xOverA[2] = {4271,4420};
/*
