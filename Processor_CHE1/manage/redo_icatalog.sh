...
RAW_DATA_DIR=/share/storage1/connie/data/runs/018
FID=685
LID=744

# base output directory
BASE_OUT_DIR=/share/storage1/connie/data_analysis/processed_data/runs/018
...
# doEx
cd $MACROS_DIR
nohup ./doIEx.sh $OUT_DIR >> $OUT_DIR/data_$SUFFIX.log.iext 2>&1 &
cd -
