...
RAW_DATA_DIR=/share/storage1/connie/data/runs/021
FID=898
LID=903

# user output directory
USER_OUT_DIR=/share/storage1/connie/data_analysis/processed_data/runs/021
...
# doAll
cd $MACROS_DIR
nohup ./doEx.sh $BASE_OUT_DIR >> $BASE_OUT_DIR/data_$SUFFIX.log 2>&1 &
cd -
